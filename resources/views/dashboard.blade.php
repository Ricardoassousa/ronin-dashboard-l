<x-app-layout>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-blue-700 text-white p-6 shadow rounded flex flex-col items-center">
                        ...
                        <canvas id="usersSparkline" class="mt-2 w-full" height="40"></canvas>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-green-500 to-green-700 text-white p-6 shadow rounded flex flex-col items-center">
                        ...
                        <canvas id="ordersSparkline" class="mt-2 w-full" height="40"></canvas>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-purple-500 to-purple-700 text-white p-6 shadow rounded flex flex-col items-center">
                        ...
                        <canvas id="revenueSparkline" class="mt-2 w-full" height="40"></canvas>
                    </div>
    ...
    <script>
        ...
        // Mini-sparklines (dummy example)
        const sparklineData = {!! json_encode($ordersPerDay->values()) !!};
        ['usersSparkline','ordersSparkline','revenueSparkline'].forEach((id) => {
            new Chart(document.getElementById(id).getContext('2d'), {
                type: 'line',
                data: { labels: sparklineData.map((_,i)=>i+1), datasets: [{ data: sparklineData, borderColor: 'rgba(255,255,255,0.8)', borderWidth: 2, tension: 0.3, fill: false }]},
